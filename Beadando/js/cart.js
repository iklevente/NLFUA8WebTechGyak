...
function myCartMethod() {
  ...
  fetch("https://jsonserver-ihm9.onrender.com/products/" + productId)
    .then((res) => res.json())
    .then((data) => {
...
function updateCart() {
  ...
  for (var i = 0; i < cartItems.length; i++) {
    (function (index) {
      fetch("https://jsonserver-ihm9.onrender.com/products/" + cartItems[index])
        .then((res) => res.json())
        .then((data) => {
...
function searchProducts(query) {
  flag = false;
  fetch("https://jsonserver-ihm9.onrender.com/products/search?q=" + query)
